        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center text-center">
            ...
            <div className="relative mb-6">
              <div className="w-48 h-48 rounded-full border-4 border-purple-600 overflow-hidden">
                <img
                  src={principalImage}
                  alt="Principal"
            ...
            <p className="text-gray-700 leading-relaxed mb-8">
              It's my pleasure to welcome you to Tetu Technical and Vocational
              College. We are committed to providing quality programs,
              activities, and services that will enhance and enrich your
          ...
          <div className="lg:col-span-2 grid gap-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {/* Admissions Card */}
              <div className="bg-blue-600 rounded-2xl shadow-lg p-8 text-white flex flex-col items-center text-center">
              ...
              {/* Resources Card */}
              <div className="bg-green-600 rounded-2xl shadow-lg p-8 text-white flex flex-col items-center text-center">
