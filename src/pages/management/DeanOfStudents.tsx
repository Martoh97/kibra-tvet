              ...
              <Card className="mb-12">
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    The Office of the Dean of Students is dedicated to ensuring
                    a holistic educational experience for all students at Kibra
                    TVC. We focus on student welfare, personal development, and
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <div className="space-y-1 text-sm text-muted-foreground">
                      <p>
                        <strong>Email:</strong> dean.students@kibratvc.ac.ke
                      </p>
                      <p>
