                  ...
                  <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="md:col-span-2 space-y-4">
                      ...
                      <p className="text-muted-foreground">
                        ...
                        and knowledge needed to excel in their chosen careers.
                        We maintain strong partnerships with industry
                        stakeholders to ensure our programs meet current market
                        demands.
                      </p>
                      <p className="text-muted-foreground">
                        I encourage all students to take full advantage of the
                        excellent facilities, dedicated faculty, and
                        comprehensive programs we offer. Together, we can build
                        a brighter future for our community and nation.
                      </p>
                    </div>
                  </div>
                </CardContent>
