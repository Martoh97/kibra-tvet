            ...
            <div className="max-w-4xl mx-auto">
              <Card className="mb-12">
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Our office ensures compliance with regulatory requirements
                    and institutional policies while providing efficient and
                    courteous service to students, staff, and external
                    stakeholders.
                  </p>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <div className="space-y-1 text-sm text-muted-foreground">
                      <p>
                        <strong>Email:</strong> registrar@kibratvc.ac.ke
                      </p>
                      <p>
              ...
              <Card>
                ...
                <CardContent>
                  <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
                    ...
                    <li>
                      Pay applicable processing fees at the Finance Office
                    </li>
                    <li>
