...
const OurProgrammes = () => {
  const departments = [
    ...
    {
      name: "Mechanical and Automotive Department",
      courses: [
        {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-primary via-primary to-primary/90 text-primary-foreground py-24 overflow-hidden">
